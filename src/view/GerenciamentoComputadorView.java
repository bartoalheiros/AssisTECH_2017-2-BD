...
import control.ControladorComputador;
...
public class GerenciamentoComputadorView extends JFrame {
	...
	private void initComponents(/*Connection con*/) {
		...
		scrollPane.setBounds(0, 204, 519, 240);
		...
		table.setModel(new DefaultTableModel(
				...
				new String[] {
						"Cod_equipamento", "Sistema_Operacional", "Endereco_Ip", "Fabricante_bios", "Vercsao_Bios", "Tipo"
				}
				) {
		...
		btn_buscar.setBounds(435, 36, 74, 30);
		...
		btnCadastrar.setBounds(251, 8, 81, 23);
